...
def get_instagram_scrape_prompt_with_previous_posts(
    hashtag: str,
    n_results: int,
    user_email: str,
    user_password: str,
...
Below is a list of URLs (post_link) of posts already visited (which you should not process if you see that you access a post that has any of the following links):
